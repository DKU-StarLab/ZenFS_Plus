...
unsigned long zns_write_request(const void * write_data, __le16 nblocks, __le32 data_size, __u64 slba)
{
...
int zns_write(const void * write_data, unsigned int data_size, unsigned int zone_number)
{
    int i;
    int result;
    __le16 nblocks;
